...
%% Ouptput Matrix
wavelengths = (600: 25: 610);
bo_arr = (0.95: 0.05: 0.96);
...
for bo_val = bo_arr
    ...
    for wave = wavelengths
        ...
        mua_ep1 = get_mua_epidermis(wave, 1.865);

        bo_level = 0.9;
        % model.MC.wavelength
        [mua_h, mua_d] = get_mua_from_blood(model.MC.wavelength, MU);
...
function [mua_h, mua_d] = get_mua_from_blood(wavelength, MU)
